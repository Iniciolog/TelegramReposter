...
export default function DraftsPage() {
  ...
  return (
    <div className="container mx-auto py-4 lg:py-6 space-y-4 lg:space-y-6 max-w-full overflow-x-hidden px-4">
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div className="min-w-0">
          <h1 className="text-2xl lg:text-3xl font-bold tracking-tight truncate">Черновики</h1>
